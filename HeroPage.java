...
public class HeroPage extends JFrame {
    ...
    public HeroPage() {
        ...
        layeredPane.add(lblNewLabel, new Integer(0));  // Add with layer index 0
        lblNewLabel.setIcon(new ImageIcon(HeroPage.class.getResource("/HotelReservationSystem/pexels-photo-4223678new.png"))); // Set the original icon, resized later
        ...
        layeredPane.add(btnNewButton, new Integer(1));  // Add with layer index 1 (above the label)
        ...
        // Resize image on component resize
        addComponentListener(new java.awt.event.ComponentAdapter() {
            public void componentResized(java.awt.event.ComponentEvent evt) {
                // Resize the image and set it to the label
